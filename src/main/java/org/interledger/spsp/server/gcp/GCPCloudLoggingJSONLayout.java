...
/**
 * For GCP logging. Copied from: https://stackoverflow.com/questions/44164730/gke-stackdriver-java-logback-logging-format
 *
...
public class GCPCloudLoggingJSONLayout extends PatternLayout {
  ...
  /**
   * For testing without having to deal wth the complexity of super.doLayout() Uses formattedMessage instead of
   * event.getMessage()
   */
