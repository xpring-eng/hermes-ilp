...
import org.testcontainers.shaded.com.google.common.primitives.UnsignedLong;
...
public class RedisHermesPaymentTrackerTest extends AbstractRedisPaymentTrackerTest {
  ...
  private Payment registerPayment(UUID paymentId) {
    ...
    final long originalAmount = 1000L;
    ...
    assertThat(registeredPayment.originalAmount().longValue()).isEqualTo(originalAmount);
  ...
  public void updatePaymentOnComplete() {
    ...
    long amountSent = 1000L;
    long amountDelivered = 1000L;
    long amountLeftToSend = 0L;
    ...
    assertThat(updatedPayment.originalAmount().longValue()).isEqualTo(registeredPayment.originalAmount().longValue());
    ...
    assertThat(updatedPayment.amountDelivered().longValue()).isEqualTo(amountDelivered);
    assertThat(updatedPayment.amountSent().longValue()).isEqualTo(amountSent);
    assertThat(updatedPayment.amountLeftToSend().longValue()).isEqualTo(amountLeftToSend);
  }
}
